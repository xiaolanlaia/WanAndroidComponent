...
import com.example.commonlibrary.util.SizeUtil
...
class AppToolBar : RelativeLayout {
    ...
    private fun showBlackColor() {
        ...
        title.setTextColor(context.resources.getColor(R.color.color_333333))
    }
    ...
    fun showLoginTitle(){
        title.visibility = View.VISIBLE
        title.textColor = view.context.resources.getColor(R.color.color_white)
        back.visibility = View.VISIBLE
    ...
    fun setBackground(colorResource : Int){
        toolBackground.backgroundColor = context.resources.getColor(colorResource)
    }
